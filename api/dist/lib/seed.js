 ...
 */
export async function seedNewAccount(tx, accountId, userId, businessName = 'My Business') {
    ...
    await seedBoard(tx, accountId, userId, deliveryFolderId, 'Project Board', 'Example board. Rename or delete freely.', [
    ...
    await seedBoard(tx, accountId, userId, opsFolderId, 'Internal', 'Admin, finance, hiring and the recurring things that keep the lights on.', [
